...
print(r"Enter the name of the text file which contains the list of URLs (Ex:D:\Python Projects\ULR to IP automated\URL.txt)")
url_path=input()
...
path=input()
driver = webdriver.Firefox(executable_path=path) #give the path of the gecodriver.exe installed in the system
...
for i in range(0,len(links)):
    ...
    time.sleep(5)
    ips = driver.find_element_by_xpath("/html/body/section[2]/div/div/div/div[1]/div/textarea").text
    #print(ips)
    ip1= ips.splitlines()
    #print(ip1)
    l=len(ip1)
    ...
    leap=leap+l
print(r"Enter the destination of the file to be saved (Ex: D:\\Python Projects\\ULR to IP automated\\):")
path_wb1=input()
